...
const handleUploadCategorias = upload.single('categorias'); // el nombre del campo en el formulario del cliente
const handleUploadProductos = upload.single('productos'); // el nombre del campo en el formulario del cliente


module.exports = {handleUploadDepartamentos, handleUploadCiudades,handleUploadCategorias,handleUploadProductos};